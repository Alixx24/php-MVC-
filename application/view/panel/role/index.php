...
<section class="mb-2 d-flex justify-content-between align-items-center">
    ...
    <a href="<?php $this->url('role/create'); ?>" class="btn btn-sm btn-success">Create</a>
</section>

<section class="table-responsive">
<form method="POST" action="<?php $this->url('role/bulkDestroy'); ?>" id="bulkDeleteForm">
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php foreach($roles as $role) { ?>
                <tr>
                    <td><input type="checkbox" name="ids[]" value="<?php echo $role['id']; ?>" class="selectItem"></td>
                    ...
                    <td>
                        ...
                        <a href="" class="btn btn-danger btn-sm delete-link-article">Delete</a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
